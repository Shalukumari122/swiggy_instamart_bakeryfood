...
#
#                     }
#                     # 'Location_info'= '{"address":"New Delhi, Delhi 110017, India","lat":28.5279118,"lng":77.20889869999999,"id":"","annotation":"","name":""}'
#
...
#                             )
#                         else:
#                             urls = f'https://www.swiggy.com/api/instamart/search?pageNumber={page}&searchResultsOffset=0&limit=40&query={encoded_keyword}&ageConsent=false&layoutId=3990&pageType=INSTAMART_AUTO_SUGGEST_PAGE&isPreSearchTag=false&highConfidencePageNo=0&lowConfidencePageNo=0&voiceSearchTrackingId=&storeId={storeid}',
#
#                             yield scrapy.Request(
#                                 # url=urls[0],
...
#             # variations=result['data']['widgets'][0]
...
#
#
#     # execute(f'scrapy crawl spider -O {folder_loc}swiggy_instamart_bakeryfood_{today_date_time}.json'.split())
